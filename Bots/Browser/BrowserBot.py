...
class BrowserBot:
    ...
    def release(self, clear_downloads: bool = False) -> None:
        ...
        if self.driver is not None:
            if isinstance(self.driver, webdriver.Chrome) and platform == "win32":
    ...
    @property
    def addon_uris(self):
        driver_name = "chrome" if platform != "win32" and self.__driver_conf["executable_name"] == "chromium" else \
            self.__driver_conf["executable_name"]
        return Configuration.getExtensions(driver_name)
